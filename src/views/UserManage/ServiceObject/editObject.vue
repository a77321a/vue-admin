 ...
 * @LastEditors:
 * @LastEditTime: 2019-11-28 20:07:36
 -->
<template>
  <div id="edit-event">
    <!-- label-suffix="：" -->
    ...
    >
      ...
      <el-form-item label="头像" prop="avatar">
        <div style="display:flex;align-items:center;">
          <div v-show="formInfo.avatar" class="avatar">
            <img
              :src="
      ...
      <el-form-item label="证件信息" prop="idCard">
        ...
        市民卡：
        <el-input
          placeholder="请输入服务对象市民卡信息"
          v-model="formInfo.citizenCard"
          style="width:300px"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="详细地址" prop="address">
        <el-input
          placeholder="请输入服务对象详细住址，最多不超过60个字"
          show-word-limit
      ...
      <el-form-item label="紧急联系人" prop="emergencyList">
        <el-button type="primary" @click="dialogServiceObject = true"
          >选择人员</el-button
        >
