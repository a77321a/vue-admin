 ...
 * @LastEditors:
 * @LastEditTime: 2019-11-24 17:34:31
 -->
<template>
  <div id="edit-event">
    <!-- label-suffix="：" -->
      ...
      <el-form-item label="头像" prop="avatar">
        <div style="display:flex;align-items:center;">
          <div v-show="formInfo.avatar" class="avatar">
            <img :src="$store.state.config.systemConfig[0].dictionaryValue+formInfo.avatar" alt />
          </div>
          <el-upload
      ...
      <el-form-item style="color:#666" label="已选人员">
        <el-card style="margin-top:10px;" shadow="never">
          ...
          >
            ...
            >{{item.serviceCustomerName||item.orgServiceProviderName||item.name}}</span>
          </el-tag>
        </el-card>
      </el-form-item>
