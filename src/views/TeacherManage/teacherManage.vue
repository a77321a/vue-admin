  ...
  <div class="user-manage">
    ...
    <el-form inline ref="form" label-width="80px" size="small">
      ...
      <el-form-item label="讲师类型">
        <el-cascader v-model="searchData.teacher_classfiy"></el-cascader>
      </el-form-item>
      <el-form-item label="讲师名称">
        <el-input placeholder="请输入关键字" v-model="searchData.user_name"></el-input>
      </el-form-item>
      ...
      <el-form-item label=" ">
        ...
        <el-button type="primary" @click="getTeacherList" icon="el-icon-search">搜索</el-button>
      </el-form-item>
    </el-form>
    <!-- 列表 -->
    <el-table
    ...
    >
      ...
      <el-table-column prop="status" label="讲师状态" width="70" align="center">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.status == 1" size="small">正常</el-tag>
          <el-tag v-else type="warning" size="small">禁用</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="created_at" label="创建日期" width="135"></el-table-column>
      <el-table-column fixed="right" prop="mobile" label="操作" width="330">
        <template slot-scope="scope">
          <el-button size="mini" type="primary">查看详情</el-button>
          <el-button size="mini" type="primary">主讲课程</el-button>
